                    ...
                    <div class="span6">
                        <fieldset>
                            ...
                            echo $this->TwitterBootstrap->input("Post.content", array("class" => "span4",
                                                                                      "rows" => "15"));
                            echo $this->Html->div("row format-guide", 
                                                  $this->Html->div("offset2 span4", $this->Html->link(__("Formatting guide"), "#", array("id" => "formatting-guide-link")))); 

                            echo $this->element("UrgPost.formatting_guide", array("dom_id" => "formatting-guide"));

                            $comment_msg = __("Allow users to comment about this post.");
                            echo $this->TwitterBootstrap->input("Post.commentable", 
                                                                array("help_inline" => $comment_msg,
                                                                      "label" => false));
